function run_conn_small(normType, kerType, v, runtimes)
...
fname = 'connect_data/conn_small.mat';
...
for li = 1:length(labeledRatio)
   ...
   filename = ['connect_output/wkfdor_results_connectsmall_',num2str(labeledRatio(li)),'.dat'];   
...
% save results
filename = 'connect_output/wkfdor_results_connectsmall.dat';
