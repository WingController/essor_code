function [results_kfdor,results_fkfdor,results_efkfdor] = searchAndTest_spmd_semi_nonCV_newData(sortedData,binSize,K,trainSize,labeledRatio,testSize,runtimes,kerType,I_itermax,saveItr,objFuncName)
