function search_params_spmd_semi_nonCV_newData(sortedData,binSize,K,trainSize,labeledRatio,testSize,runtimes,kerType)
...
fprintf('\n\n\n%s kernel, non-cv model selection results, %d datasets pairs, %d trials tests results:\n',kerType,v,runtimes);
