function run_conn(normType, kerType, v, runtimes)
...
fname = 'connect_data/conn_enc.mat';
...
for li = 1:length(labeledRatio)
   ...
   filename = ['connect_output/wkfdor_results_connect_',num2str(labeledRatio(li)),'.dat'];   
...
% save results
filename = 'connect_output/wkfdor_results_connect.dat';
