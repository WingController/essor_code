function run_sushi_all(normType, kerType, v, runtimes)
...
load('sushi_data/sushi_all_params.mat');
...
for li = 1:length(labeledRatio)
   ...
   %filename = ['sushi_output/wkfdor_results_sushi_all_small_',num2str(labeledRatio(li)),'.dat'];   
   filename = ['sushi_output/wkfdor_results_sushi_all_middle_',num2str(labeledRatio(li)),'.dat'];   
...
% save results
%filename = 'sushi_output/wkfdor_results_sushi_all_small.dat';
filename = 'sushi_output/wkfdor_results_sushi_all_middle.dat';
