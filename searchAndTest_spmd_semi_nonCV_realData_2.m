function [results_kfdor,results_fkfdor,results_efkfdor,kfdor_cell,fkfdor_cell,efkfdor_cell] = searchAndTest_spmd_semi_nonCV_realData_2(sortedData,binSize,K,trainSize,labeledRatio,testSize,runtimes,kerType,I_itermax,lb,ub,saveItr,objFuncName)
