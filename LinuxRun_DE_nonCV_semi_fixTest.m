...
[test_trainSet,test_testSet] = genSet_2(sortedData,binSize,K,trainSize,testSize);
tic;
resultsMat = [];
for li = 1:length(labeledRatio)
   fprintf('\n\n\n labeledRatio = %f.\n',labeledRatio(li));
   [results_kfdor,results_fkfdor,results_efkfdor] = searchAndTest_spmd_semiNonCV_fixTest(sortedData,binSize,K,trainSize,labeledRatio(li),testSize,test_trainSet,test_testSet,runtimes,kerType,I_itermax,saveItr,objFuncName);
