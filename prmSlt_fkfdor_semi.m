function [bestmean,beststd,bestu,bestkp,bestc] = prmSlt_fkfdor_semi(train,validation,unlabeledSet,membership,K,kerType,Ubasenum,umin,umax,ustep,KPbasenum,KPmin,KPmax,KPstep,Cbasenum,cmin,cmax,cstep,v,metric)
