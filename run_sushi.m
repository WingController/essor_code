function run_sushi(normType, kerType, v, runtimes)
...
for li = 1:length(labeledRatio)
   ...
   filename = ['sushi_output/wkfdor_results_sushi',num2str(fid),'_',num2str(labeledRatio(li)),'.dat'];   
...
% save results
filename = ['sushi_output/wkfdor_results_sushi',num2str(fid),'.dat'];
