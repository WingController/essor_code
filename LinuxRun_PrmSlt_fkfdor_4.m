...
normType = 'z_score';
kerType = 'rbf';
v = 5;  % v-fold CV for model selection
...
lgcParams = [1.584893	0.94]; % meanDist
...
lgcParams = [0.630957	0.14]; % meanDist
...
lgcParams = [0.630957	0.06]; % meanDist
...
lgcParams = [0.630957	0.6]; % meanDist
