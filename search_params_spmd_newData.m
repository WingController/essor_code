function search_params_spmd_newData(sortedData,binSize,K,trainSize,testSize,runtimes,kerType)
...
for i = 1:v
    [tmpSet,validation{i}] = randPartition(sortedData,K,size(sortedData,1)-testSize);
    [train{i},~] = randPartition(tmpSet,K,trainSize);
end
