function [FVr_x,saveProc] = runDE(K,labeled,unlabeled,membership0,kerType,fkfdorParams,I_itermax,saveItr,objFuncName)
...
[FVr_x,saveProc,genBestObj,S_y,I_nf] = deopt_saveProc(objFuncName,S_struct,saveItr);  % DE
S_y
I_nf
